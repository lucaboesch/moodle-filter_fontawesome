...
if (class_exists('\core_filters\text_filter')) {
    class_alias('\core_filters\text_filter', 'filter_fontawesome_base_text_filter');
} else {
    class_alias('\moodle_text_filter', 'filter_fontawesome_base_text_filter');
}

/**
 * Filter main class for the filter_fontawesome plugin.
 *
 ...
 */
class text_filter extends \filter_fontawesome_base_text_filter {
